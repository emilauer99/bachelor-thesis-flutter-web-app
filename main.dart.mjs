...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1283: x0 => x0.decode(),
      _1284: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1285: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1288: x0 => x0.send(),
      _1289: () => new XMLHttpRequest(),
      _1290: (x0,x1) => x0.removeItem(x1),
      _1292: (x0,x1) => x0.getItem(x1),
      _1293: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      _1294: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      _1295: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      _1296: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      _1297: (x0,x1,x2) => x0.exportKey(x1,x2),
      _1298: (x0,x1) => x0.getRandomValues(x1),
      _1299: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      _1300: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      _1301: Date.now,
      ...
      _1466: (x0,x1,x2) => x0.setItem(x1,x2),
      _1467: (s, m) => {
        try {
      ...
      _1540: () => globalThis.document,
      _1560: x0 => x0.src,
      _1561: (x0,x1) => x0.src = x1,
      _1562: x0 => x0.naturalWidth,
      _1563: x0 => x0.naturalHeight,
      _1579: x0 => x0.status,
      _1580: (x0,x1) => x0.responseType = x1,
      _1582: x0 => x0.response,
      _1720: (x0,x1) => x0.oncancel = x1,
      _1726: (x0,x1) => x0.onchange = x1,
      _1766: (x0,x1) => x0.onerror = x1,
      _2636: (x0,x1) => x0.accept = x1,
      _2650: x0 => x0.files,
      _2676: (x0,x1) => x0.multiple = x1,
      _2694: (x0,x1) => x0.type = x1,
      _3412: () => globalThis.window,
      _3733: x0 => x0.crypto,
      _3738: x0 => x0.sessionStorage,
...
"? All projects of this customer will be deleted too.",
"Delete Customer",
"Error: ",
"Scrim",
"BottomSheet child",
